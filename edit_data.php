...
<link href="index1.css" rel="stylesheet">
        ...
        enctype="multipart/form-data">
            ...
            if($d['jeniskelamin']=='L') echo 'checked'?>>Laki-laki
            <input type="radio" name="jekel" value="P" <?php
            if($d['jeniskelamin']=='P') echo 'checked'?>>Perempuan
            </td>
            </tr>
            <tr>
            <td>Jurusan</td>
            ...
            <tr>
            <td>Photo</td>
            <td><input type="file" name="file"> <img src="file/<?php echo $d['photo']; ?>" 
            style="width: 100px;float: left;margin-bottom: 5px;">
            <br/><i style="float: left;font-size: 11px;color:red">
            Abaikan jika tidak merubah photo</i>
            </td>
            </tr>
            <tr>
            <td></td>
